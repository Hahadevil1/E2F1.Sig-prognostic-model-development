...
load("~/if01/Analysis/Analysis_JLX/Project07_scRNA&Bulk&ICI&PanCancer/Step3_Circos_plot/Project01_Unfolded_Protein/D04_UPR.Sig.RData")
...
AUC_UPR.Sig[which(AUC_UPR.Sig < 0.5)] <- 1-AUC_UPR.Sig[which(AUC_UPR.Sig < 0.5)]
AUC_UPR.Sig

###########################################################################################################
####==================5. Compare UPR.Sig with other Signatures in testing datasets====================####
###########################################################################################################
...
AUC[['pancancer']] <- list(UPR.Sig = data.frame(AUC = AUC_UPR.Sig[-8,]),
...
AUC[['SKCM']] <- list(UPR.Sig = AUC_UPR.Sig[8,],          
